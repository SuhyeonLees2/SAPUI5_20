		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#iitpzui52008-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iitpzui52008-display": {
								"semanticObject": "iitpzui52008",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iitp.zui52008",
									"url": sap.ui.require.toUrl("iitp/zui52008")
								}
							}
						}
					}
